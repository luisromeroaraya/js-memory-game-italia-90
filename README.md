...
- Match all 8 pairs to win — the timer stops, confetti drops, and your final moves + time are shown
...
- Hover any player name in the sidebar to see a floating card preview
...
- Falling confetti animation on win, with final moves and time displayed in the modal
